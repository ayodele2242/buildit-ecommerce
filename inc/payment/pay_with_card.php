...
$queryme = mysqli_query($mysqli,"insert into customer_order(
	...
	values('$email', '".$arrayItem['product_id']."', '".$arrayItem['title']."', '".$arrayItem['image']."', '".$arrayItem['price']."', '".$arrayItem['quantity']."', '".$arrayItem['color']."', '".$mysqli->real_escape_string($arrayItem['size'])."', '".$arrayItem['vendor']."','$amt','Credit Card','Processing','$trxId')") or die(mysqli_error($mysqli));
