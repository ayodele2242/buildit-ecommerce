...
$myproduct = vendorAwaitingProducts($username);
?>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Products Awaiting Approval</h3>
          </div>
                                ...
                                <td>
                                 ...
                                 echo $price;
                                  ...
                                  <td><?php if ($pro_info['status'] == 1) {
                                    ...
                                    echo '<span class="text-warning">Waiting Approval</span>';
                                  }
                                   ?>
                                  </td>
                                  <td>
