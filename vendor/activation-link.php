 ...
 <div class="container py-4 py-lg-5 my-4">
      <div class="row justify-content-center">
        ...
        <div class="col-lg-8 col-md-10">
          <h2 class="h3 mb-4">Get your account activation link?</h2>
          <p class="font-size-md">Please enter your registered email below to get a link for your account activation.</p>
          ...
          <div class="card py-2 mt-4">
            <form class="card-body" id="form_reset_pwd">
              ...
              <button class="btn btn-primary forgot_password" type="submit">Send</button>  -or-  <a href="account-signin" class="col-blue">Sign In</a>
            </form>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  ...
  var url = "../inc/sellers/resend_activation_code.php";       
