...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" media="screen" href="<?php echo $set['installUrl']; ?>shop/css/vendor.min.css">
    <!-- Main Theme Styles + Bootstrap-->
    <link rel="stylesheet" media="screen" id="main-styles" href="<?php echo $set['installUrl']; ?>shop/css/theme.css">
    ...
    <link href="<?php echo $set['installUrl']; ?>shop/css/jquery-ui.css" rel="stylesheet">
