                           ...
                           if (isset($ads_info) && $ads_info !="") {
                            foreach ($ads_info as $key => $info_ads) {
                                ...
                                <tr>
                                  ...
                                  <img src="<?php echo UPLOAD_URL.'adv/'.$info_ads->image;?>"  class="img img-thumbnail" >
                                </div>
                                <?php 
                              }
                                 ?>
                                ...
                                <td>
                                 <button class="btn-floating waves-effect waves-light gradient-45deg-amber-amber edit-ads" value='<?php echo json_encode($info_ads); ?>'><i class="fa fa-pencil"></i></button>
                                  <?php 
                                  $url="process/ads?id=".$info_ads->id."&act=".substr(md5($_SESSION['session_id'].'del_ads-'.$info_ads->id), 5, 15)
                                  ?>
                                  <a href="<?php echo $url; ?>" class="btn-floating waves-effect waves-light gradient-45deg-red-pink " onclick= "return confirm('Are you sure you want to delete this ads?');"><i class="fa fa-trash"></i></a>
                                </td>
                                </tr>
                                <?php
                              }  
