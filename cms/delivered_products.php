...
$myproduct = adminproductDelivered();
      ?>
                          ...
                          if ($myproduct) {
                            ...
                            foreach ($myproduct as $pro_info) {
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php 
                                  if($pro_info['amount_issued'] != ""){
                                    echo '<span class="text-success"><i class="fa fa-check"></i> Payment Settled</span>';
                                   
                                  }else{
                                  ?>
                                    <a href="#orderModal" class="btn btn-info delivery_status"  id="<?php echo $pro_info['id']; ?>" data-toggle="modal" data-backdrop="false" data-name="<?php echo $pro_info['product_name']; ?>" data-target="#orderModal">Click to Pay Seller</a> 
                                  <?php
                                  }
                                  ?>
                               ...
                               echo number_format($pro_info['product_price']);
                                  ...
                                  <td><?php  echo $pro_info['delivery_date']; ?></td>
