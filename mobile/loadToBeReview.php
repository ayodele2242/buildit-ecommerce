                            ...
                            <form id="reviewForm">
                                <div class="form-group boxed">
                                    <div class="input-wrapper">
                                        ...
                                        <select class="form-control custom-select mselect" name="rate">
                                    ...
                                    <div class="input-info">Select product rating</div>
                                </div>
                          ...
                          <div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <div class="form-group basic">
                                   <input type="hidden" class="form-control form-control-lg" id="proid" name="product_id" >
