            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="item post-item postid results" id="<?php echo $row['id']; ?>">
                        ...
                        <div>
                            ...
                            <p>Order Status: 
                               <?php 
                                ...
                                echo ' <span class="text-success"><i class="material-icons">done_all</i> Delivered</span>';
                                }
                    ...
                    <div class="right">
                        ...
                        ?>
                        <div class="mt-2">
                          <a href="#" id="<?php echo $row['product_id']; ?>" data-product="<?php echo $row['product_name']; ?>" class="btn btn-warning returningBtn" data-toggle="modal" data-target="#actionReviewSheetForm">Return</a>
                        </div>
                            ...
                            <div class="input-wrapper">
                                ...
                                <div class="form-group basic">
                                   ...
                                   <input type="hidden" name="email" value="<?php echo $email; ?>">
                                    <button type="button" class="btn btn-warning btn-block btn-lg" id="reviewFormBtn" 
                                        >Submit</button>
                                </div>
                            </form>
