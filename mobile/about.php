        ...
        <div class="section mt-3 mb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    Finapp is Bootstrap 4 based template for your wallet, banking, financial mobile projects.
                </div>
            </div>
        </div>
        ...
        <div class="section mt-3 mb-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="app-contact.html" class="btn btn-primary"><ion-icon name="mail-open-outline"></ion-icon> Contact</a>
                </div>
            </div>
        </div>
